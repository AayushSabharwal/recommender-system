...
similarity_files = ['all_similarities/director-similarity', 'all_similarities/genre-similarity', 'all_similarities/tags-similarity']
...
#res = op.minimize(weightfn, weights, hess=hessfn, method='BFGS', options={'disp': True}, args=(adj_mat, ))
